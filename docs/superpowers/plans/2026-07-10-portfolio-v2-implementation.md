...
- Build the responsive open composition, cool-neutral reading surfaces, portrait-derived color fields, restrained seams, focus styles, and reduced-motion rules.
...
- Build the capability-first open hero with clear portrait placement, location, and availability.
